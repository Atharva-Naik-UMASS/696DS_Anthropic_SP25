...
def test_mask_labels():
    ...
    model_name = "/datasets/ai/llama3/hub/models--meta-llama--Llama-3.2-3B/snapshots/13afe5124825b4f3751f836b40dafda64c1ed062"
    try:
        # Use the same loading method as in the main script
        model, tokenizer = FastLanguageModel.from_pretrained(
            model_name=model_name,
            max_seq_length=512,
            dtype="float16",  # Use an appropriate dtype
        )
    except Exception as e:
        print(f"Error loading with FastLanguageModel: {e}")
